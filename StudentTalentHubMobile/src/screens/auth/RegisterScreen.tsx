...
const styles = StyleSheet.create({
  ...
  tabContainer: {
    ...
    maxWidth: isTablet ? (isLargeTablet ? 500 : 450) : '100%',
    alignSelf: 'center',
  },
  tab: {
    flex: 1,
    paddingVertical: isTablet ? (isLargeTablet ? 20 : 18) : 12,
    paddingHorizontal: isTablet ? (isLargeTablet ? 30 : 26) : 20,
    borderRadius: 12,
    alignItems: 'center',
  },
  activeTab: {
  ...
  form: {
    ...
    borderRadius: 20,
    padding: isTablet ? (isLargeTablet ? 50 : 45) : 20,
    shadowColor: '#000',
    shadowOffset: {
      width: 0,
      height: 10,
