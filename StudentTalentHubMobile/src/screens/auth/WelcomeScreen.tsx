              ...
              <View style={[styles.featuresGrid, isTablet && styles.featuresGridTablet]}>
                <View style={styles.featureCard}>
                  <View style={styles.featureIconContainer}>
                    <Ionicons name="star" size={isTablet ? (isLargeTablet ? 40 : 36) : 32} color="#FFC540" />
                ...
                <View style={styles.featureCard}>
                  <View style={styles.featureIconContainer}>
                    <Ionicons name="briefcase" size={isTablet ? (isLargeTablet ? 40 : 36) : 32} color="#FFC540" />
                    <View style={styles.iconGlow} />
                  </View>
                ...
                <View style={styles.featureCard}>
                  <View style={styles.featureIconContainer}>
                    <Ionicons name="people" size={isTablet ? (isLargeTablet ? 40 : 36) : 32} color="#FFC540" />
                    <View style={styles.iconGlow} />
                  </View>
                ...
                <View style={styles.featureCard}>
                  <View style={styles.featureIconContainer}>
                    <Ionicons name="trending-up" size={isTablet ? (isLargeTablet ? 40 : 36) : 32} color="#FFC540" />
                    <View style={styles.iconGlow} />
                  </View>
            ...
            >
              <View style={styles.buttonRow}>
                ...
                >
                  ...
                  >
                    <Ionicons name="log-in-outline" size={isTablet ? (isLargeTablet ? 28 : 26) : 24} color="#8F1A27" />
                ...
                >
                  <View style={styles.joinButtonContent}>
                    <Ionicons name="person-add-outline" size={isTablet ? (isLargeTablet ? 28 : 26) : 24} color="#FFC540" />
...
const styles = StyleSheet.create({
  ...
  header: {
    alignItems: 'center',
    marginTop: isTablet ? (isLargeTablet ? 60 : 50) : 80,
    zIndex: 1,
  },
  logoContainer: {
    position: 'relative',
  ...
  featuresGridTablet: {
    paddingHorizontal: isLargeTablet ? 20 : 15,
    justifyContent: isLargeTablet ? 'space-around' : 'space-between',
  },
  featureCard: {
    width: isTablet ? (isLargeTablet ? '45%' : '48%') : '48%',
    backgroundColor: 'rgba(255, 197, 64, 0.05)',
    borderRadius: 15,
    padding: isTablet ? (isLargeTablet ? 30 : 25) : 20,
    marginBottom: isTablet ? (isLargeTablet ? 30 : 25) : 20,
    alignItems: 'center',
    borderWidth: 1,
  ...
  featureIconContainer: {
    width: isTablet ? (isLargeTablet ? 80 : 70) : 60,
    height: isTablet ? (isLargeTablet ? 80 : 70) : 60,
    borderRadius: isTablet ? (isLargeTablet ? 40 : 35) : 30,
    backgroundColor: 'rgba(255, 197, 64, 0.1)',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  buttonContainer: {
    marginBottom: isTablet ? (isLargeTablet ? 40 : 50) : 50,
    zIndex: 1,
  ...
  signInButton: {
    borderRadius: 25,
    height: isTablet ? (isLargeTablet ? 65 : 60) : 55,
    flex: 0.48,
    overflow: 'hidden',
    position: 'relative',
    shadowColor: '#FFC540',
