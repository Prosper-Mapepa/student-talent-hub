...
import { Job, Application, JobType, ExperienceLevel, ApplicationStatus, RootStackParamList } from '../../types';
  ...
  return (
    <View style={styles.container}>
      <DashboardHeader
        ...
        right={
          <HeaderIconButton icon="add" onPress={() => openJobModal()} variant="gold" />
        }
      />
      ...
      >
        ...
        >
          <Ionicons name="trending-up" size={22} color={COLORS.gold400} />
          <View style={styles.upgradeBannerText}>
            <Text style={styles.upgradeBannerTitle}>Upgrade hiring plan</Text>
            <Text style={styles.upgradeBannerSubtitle}>Featured listings from $99/mo</Text>
          </View>
