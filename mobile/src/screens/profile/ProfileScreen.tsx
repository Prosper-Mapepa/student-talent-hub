...
import DashboardHeader, { HeaderIconButton } from '../../components/dashboard/DashboardHeader';
      ...
      >
        <View style={styles.upgradeBannerContent}>
          <View style={styles.upgradeBannerIcon}>
            <Ionicons name="diamond" size={22} color={COLORS.gold400} />
          </View>
          <View style={styles.upgradeBannerText}>
            <Text style={styles.upgradeBannerTitle}>Upgrade to VeriTalent Plus</Text>
            <Text style={styles.upgradeBannerSubtitle}>
              {user?.role === UserRole.BUSINESS
                ? 'Featured listings & unlimited hiring tools'
                : 'Verified badge, analytics & priority visibility'}
            </Text>
          </View>
    ...
    >
      ...
      <View style={styles.bioSection}>
        <View style={styles.sectionHeader}>
          <Ionicons name="chatbubble-ellipses" size={20} color="#04342c" />
        ...
        >
          ...
          <View style={styles.bioEditHint}>
            <Ionicons name="create-outline" size={16} color="#0f6e56" />
      ...
      <View style={styles.portfolioSection}>
          <View style={styles.sectionHeader}>
          <Ionicons name="briefcase" size={20} color="#04342c" />
        ...
        <View style={styles.navigationCards}>
          <TouchableOpacity style={styles.navCard} onPress={() => navigation.navigate('MyTalents')}>
            <View style={styles.navCardContent}>
              <View style={styles.navCardIconContainer}>
                <Ionicons name="star" size={24} color="#04342c" />
          </View>
          ...
          <TouchableOpacity style={styles.navCard} onPress={() => navigation.navigate('Skills')}>
            <View style={styles.navCardContent}>
              <View style={styles.navCardIconContainer}>
                <Ionicons name="code" size={24} color="#04342c" />
            </View>
              <View style={styles.navCardText}>
          ...
          <TouchableOpacity style={styles.navCard} onPress={() => navigation.navigate('Projects')}>
            <View style={styles.navCardContent}>
              <View style={styles.navCardIconContainer}>
                <Ionicons name="folder" size={24} color="#04342c" />
            </View>
              <View style={styles.navCardText}>
          ...
          <TouchableOpacity style={styles.navCard} onPress={() => navigation.navigate('Achievements')}>
            <View style={styles.navCardContent}>
              <View style={styles.navCardIconContainer}>
                <Ionicons name="trophy" size={24} color="#04342c" />
            </View>
              <View style={styles.navCardText}>
      ...
      <View style={styles.securitySection}>
        <View style={styles.sectionHeader}>
          <Ionicons name="lock-closed" size={20} color="#04342c" />
        ...
        <TouchableOpacity style={styles.changePasswordButton} onPress={() => setShowChangePasswordModal(true)}>
          <View style={styles.changePasswordButtonContent}>
            <Ionicons name="key" size={20} color="#04342c" />
    ...
    return (
      ...
      >
        ...
        <View style={styles.businessSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="chatbubble-ellipses" size={20} color="#0f6e56" />
        ...
        <View style={styles.businessSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="information-circle" size={20} color="#0f6e56" />
        ...
        <View style={styles.businessSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="briefcase" size={20} color="#0f6e56" />
                    ...
                    <View style={styles.businessJobMeta}>
                      ...
                      {job.applications && job.applications.length > 0 && (
                        <View style={[styles.businessJobBadge, styles.applicationBadge]}>
                          <Ionicons name="people" size={12} color="#0f6e56" />
  ...
  return (
    <View style={styles.container}>
      <DashboardHeader
        ...
        subtitle="Manage your portfolio and account"
        right={
          <>
            <HeaderIconButton icon="create" onPress={() => setShowEditModal(true)} variant="gold" />
            <HeaderIconButton icon="log-out" onPress={handleLogout} />
          </>
        }
      />
...
const styles = StyleSheet.create({
  ...
  statDivider: {
    width: 1,
    height: 28,
    backgroundColor: 'rgba(4, 52, 44, 0.08)',
  },
  statNumber: {
    fontSize: 17,
    fontWeight: '800',
