...
export default function StudentProfileScreen() {
            ...
            <View style={styles.projectLinks}>
              {project.githubUrl && (
                <TouchableOpacity style={styles.projectLink}>
                  <Ionicons name="logo-github" size={18} color="#0f6e56" />
                  <Text style={styles.projectLinkText}>GitHub</Text>
                </TouchableOpacity>
              )}
              {project.liveUrl && (
                <TouchableOpacity style={styles.projectLink}>
                  <Ionicons name="link" size={18} color="#0f6e56" />
  ...
  if (isLoading) {
    return (
      <View style={styles.container}>
        <StatusBar barStyle="light-content" backgroundColor="#0f6e56" translucent />
        <View style={styles.loadingContainer}>
          <Ionicons name="refresh" size={32} color="#0f6e56" />
  ...
  return (
    <View style={styles.container}>
      <StatusBar barStyle="dark-content" backgroundColor="#0f6e56" translucent />
      
      {/* Header with Gradient Background */}
      <LinearGradient
        colors={['#0f6e56', '#04342c']}
          ...
          <View style={styles.headerActions}>
            {isOwnProfile ? (
              <TouchableOpacity style={styles.editButton} onPress={handleEditProfile}>
                <Ionicons name="create" size={20} color="#0f6e56" />
              </TouchableOpacity>
            ) : (
                  <View style={styles.headerActionButtons}>
                    ...
                    >
                      <Ionicons 
                        ...
                        size={18} 
                        color={isFollowing ? "#0f6e56" : "white"} 
                      />
      ...
      >
              ...
              {/* <View style={styles.profileImageContainer}>
                {student.profileImage ? (
                  ...
                  <View style={styles.profileImagePlaceholder}>
                    <Ionicons name="person" size={48} color="#0f6e56" />
                  </View>
                )}
              </View> */}
                ...
                <View style={styles.infoChips}>
                 {student.major && (
                    <View style={styles.infoChip}>
                      <Ionicons name="school" size={14} color="#0f6e56" />
                 ...
                 {student.year && (
                    <View style={styles.infoChip}>
                      <Ionicons name="time" size={16} color="#0f6e56" />
                ...
                <View style={styles.profileMetaRow}>
                 ...
                 {student.profileViews ? (
                    <View style={styles.viewsRow}>
                      <Ionicons name="eye" size={16} color="#0f6e56" />
            ...
            <Card style={styles.resumeCard}>
              <CardContent style={styles.resumeContent}>
                <TouchableOpacity style={styles.resumeButton} onPress={handleResumeView}>
                  <Ionicons name="document-text" size={20} color="#0f6e56" />
        ...
        {student.talents && student.talents.length > 0 && (
          ...
          >
            <View style={styles.sectionHeader}>
              <Ionicons name="sparkles" size={22} color="#0f6e56" />
        ...
        {student.projects && student.projects.length > 0 && (
          ...
          >
            <View style={styles.sectionHeader}>
              <Ionicons name="folder" size={22} color="#0f6e56" />
        ...
        {student.skills && student.skills.length > 0 && (
          ...
          >
            <View style={styles.sectionHeader}>
              <Ionicons name="code-slash" size={22} color="#0f6e56" />
        ...
        {student.achievements && student.achievements.length > 0 && (
          ...
          >
            <View style={styles.sectionHeader}>
              <Ionicons name="trophy" size={22} color="#0f6e56" />
