...
const ResetPasswordScreen: React.FC = () => {
  ...
  return (
    <AuthScreenLayout centerContent>
      <AuthBranding subtitle="Set a new password" />

      <View style={[authFormStyles.form, isTablet && authFormStyles.formTablet]}>
        <Text style={styles.formDescription}>Enter your new password below.</Text>

        <View style={authFormStyles.inputContainer}>
          <Ionicons name="lock-closed-outline" size={iconSize} color={COLORS.muted} style={authFormStyles.inputIcon} />
          <TextInput
          ...
          <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={styles.eyeIcon}>
            <Ionicons name={showPassword ? 'eye-outline' : 'eye-off-outline'} size={iconSize} color={COLORS.muted} />
          </TouchableOpacity>
        </View>
        {errors.password ? <Text style={authFormStyles.fieldError}>{errors.password}</Text> : null}
        ...
        {errors.confirmPassword ? <Text style={authFormStyles.fieldError}>{errors.confirmPassword}</Text> : null}
