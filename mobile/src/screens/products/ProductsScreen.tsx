...
import { BRAND_LOGO } from '../../components/BrandLogoImage';
...
const products = [
  {
    id: 1,
    name: 'VeriTalent',
    description: 'Connect verified student talent with opportunities — showcase skills, discover roles, and grow your network.',
