...
import { BrandLogoImage, UserAvatar, BRAND_LOGO } from '../../components/BrandLogoImage';
      ...
      >
            ...
            <UserAvatar
              ...
              imageUri={
                talent.student?.profileImage
                  ? getFileUrl(talent.student.profileImage)
                  : undefined
              }
        ...
        {user?.studentId === talent.studentId && (
          <View style={styles.ownerActions}>
            ...
            >
              <Ionicons name="create" size={16} color="#0f6e56" />
  ...
  return (
    <View style={styles.container}>
      <DashboardHeader
        badge="VeriTalent"
        title="Discover"
        subtitle="Explore verified student talent"
        right={
          <>
            <HeaderIconButton
              icon={showStories ? 'eye-off' : 'eye'}
              onPress={() => setShowStories(!showStories)}
            />
            <HeaderIconButton icon="add" onPress={handleAddTalent} variant="gold" />
          </>
        }
      />
                      ...
                      <View style={styles.reelActions}>
                        ...
                        >
                          <Ionicons 
                            name={isSaved ? "bookmark" : "bookmark-outline"} 
                            size={28} 
                            color={isSaved ? COLORS.gold400 : "white"} 
                          />
                        </Pressable>
                        <Pressable
                          onPress={() => {
                        ...
                        <View style={styles.storiesBottomActions}>
                          ...
                          >
                            <Ionicons 
                              ...
                              size={28} 
                              color={savedTalents.has(currentTalent.id) ? COLORS.gold400 : "white"} 
                            />
                          </Pressable>
                          <Pressable
                            onPress={() => {
