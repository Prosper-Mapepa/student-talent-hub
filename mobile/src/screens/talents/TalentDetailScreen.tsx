...
import { BrandLogoImage, UserAvatar } from '../../components/BrandLogoImage';
                    ...
                    >
                      {isImageFile(file) ? (
                        ...
                        <View style={styles.thumbnailPlaceholder}>
                          <Ionicons name="play" size={16} color="#0f6e56" />
                        </View>
                      )}
                    </TouchableOpacity>
                  ))}
          ...
          <View style={styles.actionsCard}>
            ...
            <View style={styles.actionButtons}>
              ...
              {/* <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Ionicons name="people" size={18} color="#0f6e56" style={{ marginRight: 8 }} />
