...
import { COLORS, getJobTypeColor, getExperienceColor, DASHBOARD_PADDING_H } from '../../theme';
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <View style={[styles.modalFooter, { paddingBottom: Math.max(insets.bottom, 1) }]}>
  ...
  return (
    <View style={styles.container}>
      <DashboardHeader
        badge="Opportunities"
        title="Jobs"
        subtitle="Find roles that match your skills"
        right={
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statCard}>
          <Ionicons name="time" size={20} color="#04342c" />
        ...
        <View style={styles.statCard}>
          <Ionicons name="location" size={20} color="#04342c" />
          <Text style={styles.statNumber}>
